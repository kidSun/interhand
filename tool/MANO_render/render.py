...
save_path = osp.join('/media/sdb/sunqy/Code/hand/interhand',subset, split, capture_idx, seq_name, cam_idx)
...
for img_path in img_path_list:
    ...
    for hand_type in ('right', 'left'):
        ...
        mano_pose = torch.FloatTensor(mano_param['pose']).view(-1,3)#(16,3)
        ...
        mesh = output.vertices[0].detach().numpy() * 1000 # meter to milimeter
